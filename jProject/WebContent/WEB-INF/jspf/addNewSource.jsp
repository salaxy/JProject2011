...
<h3>Neuen Sourcecode hinzufügen / Update<input type="checkbox" onclick="showHideText(this,'addBox');" /></h3>
<fieldset id="addBox" style="display:none;">
	<legend>Neuen Sourcecode hinzufügen / Update</legend>
	<form method="POST" action="DataServlet" enctype="multipart/form-data">
		...
		<table border="0" cellspacing="3">
			<tbody>
				<!--TODO AJAX ADD FIELD-->
				<tr>
					Für ein Update des Sourcecodes, laden Sie bitte eine Datei mit gleichem Dateinamen hoch.
				</tr>
				<tr>
					<td>
