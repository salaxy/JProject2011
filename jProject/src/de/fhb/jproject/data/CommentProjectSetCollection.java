...
public class CommentProjectSetCollection extends org.orm.util.ORMSet {
	...
	*/
	 ...
	 */
	public void add(CommentProject value) {
		if (value != null) {
	 ...
	 * @param value the persistent object
	 */
	public void remove(CommentProject value) {
	 ...
	 */
	public boolean contains(CommentProject value) {
	 ...
	 */
	public CommentProject[] toArray() {
		return (CommentProject[]) super.toArray(new CommentProject[size()]);
	}
	 ...
	 */
	public CommentProject[] toArray(String propertyName) {
	 ...
	 * @return The persistent objects sorted array
	 */
	public CommentProject[] toArray(String propertyName, boolean ascending) {
